...
$questions_result = mysqli_query($conn, "SELECT * FROM questions WHERE quiz_id=$quiz_id ORDER BY id ASC");
?>
...
<body class="bg-light text-dark">
    ...
    <div class="container my-5">
        ...
        <p class="mb-4 text-muted"><?php echo htmlspecialchars($quiz['description']); ?></p>
